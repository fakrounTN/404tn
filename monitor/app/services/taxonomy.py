...
DOMAIN_PATTERNS: Dict[str, Dict[str, Any]] = {
    ...
    "economy_public_finance": {
        "strong": [
            ...
            r"money[- ]printing", r"bank lending", r"treasury bills", r"tourism revenue",
        ...
        "sub_rules": {
            "trade": [r"\btrade\b", r"commerce exterieur", r"balance commerciale", r"exportations?", r"importations?", r"exports?", r"imports?", r"التجارة الخارجية", r"الميزان التجاري", r"صادرات", r"واردات", r"تبادل تجاري"],
            "banking_monetary": [r"bank profit", r"banking", r"banque", r"benefice", r"assurance", r"insurance", r"profit", r"money supply", r"money[- ]printing", r"masse monetaire", r"planche a billets", r"bct", r"بنوك", r"البنك المركزي", r"ارباح"],
            ...
            "foreign_reserves": [r"reserves en devises", r"jours d['’]importation", r"foreign reserves", r"احتياطي العملة", r"موجودات الصرف"],

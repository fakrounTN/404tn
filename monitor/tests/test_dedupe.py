...
class TestDedupe(unittest.TestCase):
    def setUp(self):
        ...
        cursor.execute("""
            INSERT INTO evidence (
                ...
                'TAP', 'tap.info.tn', 'news_agency', 'https://www.tap.info.tn/fr/coupure-eau-sfax',
    ...
    def test_layer_1_canonical_url_match(self):
        """Layer 1: Exact canonical URL match triggers duplicate detection."""
        is_dup, reason = is_duplicate_layered(
            canonical_url="https://www.tap.info.tn/fr/coupure-eau-sfax",
    ...
    def test_layer_3_normalized_url_match(self):
        ...
        is_dup, reason = is_duplicate_layered(
            canonical_url="http://tap.info.tn/fr/coupure-eau-sfax?utm_source=rss",
            content_hash="different-hash-123",
            headline="Different headline",
            source_domain="tap.info.tn",
            conn=self.conn
    ...
    def test_layer_5_content_hash_match(self):
        """Layer 5: Exact content hash match."""
        is_dup, reason = is_duplicate_layered(

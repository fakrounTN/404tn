...
echo ""
echo "--- 3. TRAILING SLASH NORMALIZATION (Expected: HTTP 301 -> non-slash) ---"
check_redirect "/gabes/" "301" "/gabes"
check_redirect "/issues/water/" "301" "/issues/water"
check_redirect "/issues/pollution/" "301" "/issues/pollution"
check_redirect "/presidency/" "301" "/presidency"
check_redirect "/gabes/?source=test" "301" "/gabes?source=test"
